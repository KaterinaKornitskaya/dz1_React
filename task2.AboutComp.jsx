class AboutComponent extends React.Component{
    render(){
        return(
            <section className="task2AboutComp">
                 <ul>
                <li>
                ...
                <li>
                А тепер варимо сам борщ. Додаємо до бульону нарізану картоплю, солимо по смаку, далі - капусту, лавровий лист. Коли картопля буде майже готова (через 10-15 хв.), додаємо засмажку. Варимо до готовності ще 5-10 хв.
                </li>
                <li>
